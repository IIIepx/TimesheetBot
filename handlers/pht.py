...
def build_table(
    ...
    if not text_align:
        text_align = ['left'] * df.ndim
    

    if not col_align:
        col_align = ['left'] * df.ndim
  ...
  <tbody>
    ...
    if caption:
        body = body.replace("""<table class="dataframe">""",
                            f"""<table class="dataframe"><caption style="font-size: {str(font_size)}"><b>{caption}</b></caption>""")
